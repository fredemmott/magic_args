...
constexpr decltype(auto) tie_struct(T&& v) {
    ...
    // Can get rid of this mess with C++26 P1061R10 - 'Structured bindings can introduce a pack'
...
// references to external variables have the handy habit of keeping the name of the variable
// when passing as a template value parameter
template<class T>
extern T external;

template<class T, std::size_t N>
constexpr auto member_name = demangled_name<&std::get<N>(tie_struct(external<T>))>();
